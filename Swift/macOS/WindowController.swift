...
Abstract:
Primary window controller. Checks whether the user is allowed to make purchases and whether the resource file containing the product
 identifiers exists. Disables the UI when the user is not allowed to make any purchases.
*/
